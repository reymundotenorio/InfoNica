<?php
function enviar_correo($NombreUsuario, $ApellidoUsuario, $CorreoUsuario, $ContrasenaUsuario, $Confirmacion){
            ...
            <div class="content">
                ...
                <table bgcolor="">
                  ...
                  $mensaje.="<p class=\"\"><strong>Nombre: </strong>".$NombreUsuario."</p>
                            ...
                            <a href=\"http://infonica.tk/activacion.php?id=".$Confirmacion."\"  class=\"btn\">Click aquí para activar su cuenta &raquo;</a>";
...
$para      =  $CorreoUsuario;
$asunto    = 'Confirmar cuenta InfoNica';
...
if(mail($para, $asunto, $mensaje, $cabeceras)) {
  echo "<script type=\"text/javascript\">
         //  alert('Debe activar su cuenta, más información ha sido enviada a su correo electrónico');
           location.href = 'index.php?session=email';
