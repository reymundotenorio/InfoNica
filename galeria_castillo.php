	...
	<div class="row" >
		<div class="eight columns">
			<p class="bread leftalign" style="font-family: 'Comic Sans MS'">
				 Está aquí: <a href="index.php"> Inicio</a> /<a href="seleccion_tipo_imagenes.php"> Galería /<a href="galeria_castillo.php"> Fotografías de El Castillo</a>
			</p>
		</div>
...
<?php } ?>
	...
	php_thumbnails("ElCastillo","ElCastilloThumbs","lb-off");
	?>
	...
	php_image("ElCastillo","ElCastilloThumbs");
	?>
	</p>
	<?php } ?>
	...
	if (isset($_GET["ElCastillo"]) ){ ?>
      ...
      <div class="alert-box" style="background-color: #31af4b;">
         Haz click sobre la imagen para ver mapa. <a href="" class="close">x</a>
      </div>
	       ...
	       <!--  Cantidad Comentarios -->
			...
			<input type="hidden" value="<?php echo $_GET["ElCastillo"];?>" name="Nombre_Foto" />
...
if(!empty($_GET['comentarios'])){
  $RutaF = substr($_SERVER["SCRIPT_NAME"],strrpos($_SERVER["SCRIPT_NAME"],"/")+1)."?ElCastillo=".$_GET['ElCastillo']."&comentarios=".$_GET['comentarios'];
}else{
$RutaF = substr($_SERVER["SCRIPT_NAME"],strrpos($_SERVER["SCRIPT_NAME"],"/")+1)."?ElCastillo=".$_GET['ElCastillo'];
}
