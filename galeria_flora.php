	...
	<div class="row" >
		<div class="eight columns">
			<p class="bread leftalign" style="font-family: 'Comic Sans MS'">
				 Está aquí: <a href="index.php"> Inicio</a> /<a href="seleccion_tipo_imagenes.php"> Galería /<a href="galeria_flora.php"> Flora de El Castillo</a>
			</p>
		</div>
...
<?php } ?>
	...
	php_thumbnails("Flora","FloraThumbs","lb-off");
	?>
	...
	if (isset($_GET["Flora"]) ){ ?>
	       ...
	       <!--  Cantidad Comentarios -->
			...
			<input type="hidden" value="<?php echo $_GET["Flora"];?>" name="Nombre_Foto" />
            <input type="hidden" value="Flora" name="Seccion" />
...
if(!empty($_GET['comentarios'])){
  $RutaF = substr($_SERVER["SCRIPT_NAME"],strrpos($_SERVER["SCRIPT_NAME"],"/")+1)."?Flora=".$_GET['Flora']."&comentarios=".$_GET['comentarios'];
}else{
$RutaF = substr($_SERVER["SCRIPT_NAME"],strrpos($_SERVER["SCRIPT_NAME"],"/")+1)."?Flora=".$_GET['Flora'];
}
